...
static void desfunc(uint32_t *, const uint32_t *);
static void cookey(uint32_t *, uint32_t *);
...
void des_set_key(uint32_t *KnL, unsigned char *key, int edf) /* Thanks to James Gillogly & Phil Karn! */
{
	int i, j, l, m, n;
...
static void cookey(uint32_t *KnL, uint32_t *raw1)
{
	uint32_t *cook, *raw0;
	int i;
...
void des_crypt(const uint32_t *KnL, unsigned char *inblock, unsigned char *outblock)
{
	uint32_t work[2];
...
static void unscrun(uint32_t *outof,
                    unsigned char *into)
{
...
static void desfunc(uint32_t *block,
                    const uint32_t *keys)
{
